...
public class DriveFile implements Serializable {
    ...
    @JsonProperty("owners")
    private List<DriveOwner> owners = new ArrayList<DriveOwner>();
    @JsonProperty("lastModifyingUser")
    private DriveLastModifyingUser lastModifyingUser;
    @JsonProperty("shared")
     ...
     */
    @JsonProperty("owners")
    public List<DriveOwner> getOwners() {
        return owners;
    }
     ...
     */
    @JsonProperty("owners")
    public void setOwners(List<DriveOwner> owners) {
        this.owners = owners;
    }
     ...
     */
    @JsonProperty("lastModifyingUser")
    public DriveLastModifyingUser getLastModifyingUser() {
     ...
     */
    @JsonProperty("lastModifyingUser")
    public void setLastModifyingUser(DriveLastModifyingUser lastModifyingUser) {
    ...
    public Boolean isDirectory(){
    	...
    	isDirectory = (this.getMimeType().equals("application/vnd.google-apps.folder"));
