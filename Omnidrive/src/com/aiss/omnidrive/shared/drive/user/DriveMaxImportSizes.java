...
public class DriveMaxImportSizes implements Serializable {

    @JsonProperty("application/vnd.google-apps.document")
    private String applicationVndGoogleAppsDocument;
    @JsonProperty("application/vnd.google-apps.spreadsheet")
    private String applicationVndGoogleAppsSpreadsheet;
    @JsonProperty("application/vnd.google-apps.presentation")
    private String applicationVndGoogleAppsPresentation;
    @JsonProperty("application/vnd.google-apps.drawing")
    private String applicationVndGoogleAppsDrawing;
    @JsonIgnore
     ...
     */
    @JsonProperty("application/vnd.google-apps.document")
    public String getApplicationVndGoogleAppsDocument() {
     ...
     */
    @JsonProperty("application/vnd.google-apps.document")
    public void setApplicationVndGoogleAppsDocument(String applicationVndGoogleAppsDocument) {
     ...
     */
    @JsonProperty("application/vnd.google-apps.spreadsheet")
    public String getApplicationVndGoogleAppsSpreadsheet() {
     ...
     */
    @JsonProperty("application/vnd.google-apps.spreadsheet")
    public void setApplicationVndGoogleAppsSpreadsheet(String applicationVndGoogleAppsSpreadsheet) {
     ...
     */
    @JsonProperty("application/vnd.google-apps.presentation")
    public String getApplicationVndGoogleAppsPresentation() {
     ...
     */
    @JsonProperty("application/vnd.google-apps.presentation")
    public void setApplicationVndGoogleAppsPresentation(String applicationVndGoogleAppsPresentation) {
     ...
     */
    @JsonProperty("application/vnd.google-apps.drawing")
    public String getApplicationVndGoogleAppsDrawing() {
     ...
     */
    @JsonProperty("application/vnd.google-apps.drawing")
    public void setApplicationVndGoogleAppsDrawing(String applicationVndGoogleAppsDrawing) {
