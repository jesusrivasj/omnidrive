...
public class DropboxContextualMenuView extends Composite {
	...
	public DropboxContextualMenuView(final String path, ContextMenuEvent event){
		int menuHeight = 200;
		int menuWidth = 150;
