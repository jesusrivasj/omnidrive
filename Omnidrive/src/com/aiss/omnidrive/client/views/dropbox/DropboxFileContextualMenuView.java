...
public class DropboxFileContextualMenuView extends Composite {
	...
	public DropboxFileContextualMenuView(final DropboxFile file, ContextMenuEvent event){
		int menuHeight = 200;
		int menuWidth = 150;
		...
		opcionVerDetalles.addClickHandler(new ClickHandler() {
			...
			public void onClick(ClickEvent event) {
				...
				newParams.put("path",file.getPathDisplay());
				MainController.go("dropbox", newParams);
				menuContextual.hide();
			}
		});
