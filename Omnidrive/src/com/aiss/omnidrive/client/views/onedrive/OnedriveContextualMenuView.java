...
public class OnedriveContextualMenuView extends Composite {
	...
	public OnedriveContextualMenuView(final String idFile, ContextMenuEvent event){
		int menuHeight = 200;
		int menuWidth = 150;
