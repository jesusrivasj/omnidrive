...
import com.aiss.omnidrive.client.views.drive.DriveFileContextualMenuView;
	...
	public OnedriveFileView(Map<String, String> params, final OnedriveFile file){
		...
		if (file.isDirectory()) {
			...
			fileView.addDoubleClickHandler(new DoubleClickHandler() {
				...
				public void onDoubleClick(DoubleClickEvent event) {
					...
					MainController.go("onedrive", fileParams);
				}
			});
		} else {
		...
		fileView.addHandler(new ContextMenuHandler() {
			...
			public void onContextMenu(ContextMenuEvent event) {
				...
				new OnedriveFileContextualMenuView(file, event);
			}
